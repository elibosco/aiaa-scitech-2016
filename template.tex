...
\documentclass[]{aiaa-tc}% insert '[draft]' option to show overfull boxes
 ...
 \title{Nonlinear transient Fluid/Structure interaction approach using surrogate models: Industrial application to aircraft fairing vibration excited by engine efflux.}

 \author{
  E. Bosco,%
    \thanks{PhD Candidate, Component Loads - Flight Physics, 316 Route de Bayonne.}
  \ A. Lucchetti%
    \thanks{Loads Engineer, Flight Physics, 316 Route de Bayonne.}
  \ and S. Trapier%  
    \thanks{Aerodynamics Engineer, Flight Physics, 316 Route de Bayonne.}\\
  {\normalsize\itshape
   Airbus Operations SAS, Toulouse, 31300, France}\\ 
  \and
  F. G. Di Vincenzo%
   \thanks{Aeroelastic Specialist Engineer, 4 Rue du Professeur Pierre Vellas - Europarc, Immeuble Jupiter, B10.}\\
  {\normalsize\itshape
  MSC.Software, Toulouse, 31300, France}\\
  \and
  N. Gourdain%
  \thanks{Professor,Universit\'e de Toulouse, CNRS, ISAE-DAEP, 10 Avenue Edouard Belin.}\\
  {\normalsize\itshape
  Universit\'e de Toulouse, CNRS, ISAE, Toulouse, , 31055, France}\\
  \and
  J. Morlier%
  \thanks{Professor, Universit\'e de Toulouse, CNRS, ISAE-SUPAERO, ICA, 10 Avenue Edouard Belin.}\\
  {\normalsize\itshape
  Universit\'e de Toulouse, CNRS, ISAE-SUPAERO, Institut Cl\'ement Ader (ICA),\\ Toulouse, 31077, France}
 }
